...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\na𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31m𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \na𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35m𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉"
exit 1
fi
if [ ! $token ]; then
echo "𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻 𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻 ┉ ┉"
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ICCETEAM/Files_ICE/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,115872761,115872761,115872761,1365465894}   
...
send(msg.chat_id_, msg.id_,' ❒︙ اصدار  ايس \n ❒︙ الاصدار »{ v 1.6 }')
end
...
send(msg.chat_id_, msg.id_,'❒︙  عدد الكروبات الان » { '..#group..' }'..ICEk..''..ICE..'\n❒︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n ❒︙ العضو » ['..result.title_..'](t.me/'..(username or 'ICE53')..')'
status  = '\n ❒︙ تم ترقيته مطور'
...
usertext = '\n ❒︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
status  = '\n ❒︙ تم ترقيته مطور'
...
if ICE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❒︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ICE53')..') \n ❒︙ '..ICE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❒︙ العضو : {["..data.first_name_.."](T.ME/ICE53)}\n ❒︙ ["..ICE_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❒︙ عذرا » {["..data.first_name_.."](T.ME/ICE53)}\n ❒︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_, "❒︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "ICE53")..")\n❒︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ICE:teh"..msg.chat_id_).."} بجانب اسمك\n❒︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
❒ ↬⦑ SOURCE ICE ⦒ 
==================
❒ ↬︙ [Source Channel](http://t.me/ICE53)
==================
❒ ↬︙ [Source Update](http://t.me/ICE53)      
==================
❒ ↬︙ [Source developer](http://t.me/ICE50)    
===================
❒ ↬︙ [ICE programmer](http://t.me/ICE50)
===================
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❒︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ICE53')..') \n ❒︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❒︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ICE53')..') \n ❒︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
local json_file, res = https.request("https://raw.githubusercontent.com/ICCETEAM/Files_ICE/main/File_Bot/"..file)
if res == 200 then
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❒︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
status  = '\n ❒︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❒︙ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❒︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❒︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ICE53')..')'..'\n ❒︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
-- vardump(data) 
ICEdx(msg.chat_id_, msg.id_, ' ❒︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n ❒︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n ❒︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n ❒︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
send(msg.chat_id_, msg.id_, t..'𓍹ⵧⵧⵧⵧⵧⵧ⊱•𝙄𝘾𝙀•⊰ⵧⵧⵧⵧⵧⵧ𓍻ٴ\n❒︙ ➫ .[ 𝙎𝙊𝙐𝙍𝘾𝞝 𝙄𝘾𝙀. ](t.me/ICE53)➤ ')
end
...
if ICE1_Msg then    
send(msg.chat_id_, msg.id_," ❒︙ "..ICE1_Msg)
