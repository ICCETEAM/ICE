...
io.popen("cd Files_ICE && wget https://raw.githubusercontent.com/ICELTEAM/Files_ICE/main/Files_ICE/commands.lua") 
...
sudo_users = {SUDO,115872761,115872761,1778724697,1786829586}   
...
local hash = database:sismember(bot_id.."ICE50:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true 
elseif tonumber(user_id) == tonumber(1778724697) then
var = true 
elseif tonumber(user_id) == tonumber(1786829586) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'ICE50:MN:TF'..chat_id, user_id) then
var = true 
...
--------------------------------------------------------------------------------------------------------------
function SourceICE(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,ICE_Msg) 
return false  
end 
if text then    
...
-------------
if text == "حصريات و تحديثات ايس" and DevSoFi(msg) then
local updatech =[[
...
send(msg.chat_id_, msg.id_,'🍷❦︎  عدد الكروبات الان » { '..#group..' }'..ICEk..''..ICE..'\n🍷❦︎  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n 🍷❦︎ العضو » ['..result.title_..'](t.me/'..(username or 'ICE53')..')'
status  = '\n 🍷❦︎ تم ترقيته مطور'
...
usertext = '\n 🍷❦︎ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
status  = '\n 🍷❦︎ تم ترقيته مطور'
...
local ICE1_Msg = database:get(bot_id.."ICE1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ICE1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🍷❦︎ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ICE53')..') \n 🍷❦︎ '..ICE1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ICE_Msg and not Special(msg) then  
local ICE_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ICE_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 🍷❦︎ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🍷❦︎ ["..ICE_Msg.."] \n")
else
send(msg.chat_id_,0," 🍷❦︎ العضو : {["..data.first_name_.."](T.ME/ICE53)}\n 🍷❦︎ ["..ICE_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " 🍷❦︎ عذرا » {["..data.first_name_.."](T.ME/ICE53)}\n 🍷❦︎ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
function ICE50_name(t1,t2)
if t2.id_ then 
name_MRSOFI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."ICE:blocname"..msg.chat_id_) or ""
...
bnnaGet(msg.sender_user_id_, ICE50_name)
end
...
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."ICE:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."ICE:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."ICE:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."ICE:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
...
send(msg.chat_id_, msg.id_, "🍷❦︎ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "ICE53")..")\n🍷❦︎ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."ICE:teh"..msg.chat_id_).."} بجانب اسمك\n🍷❦︎ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..ICEChengName..']')
...
send(msg.chat_id_, msg.id_, '*🍷❦︎تم تفعيل الرسائل اليوميه*')
database:set(bot_id.."msg:match:"..msg.chat_id_,true)
end
if text == "تعطيل الرسائل اليوميه" and Manager(msg) then
send(msg.chat_id_, msg.id_,'*🍷❦︎تم تعطيل الرسائل اليوميه*')
...
get_msg = database:get(bot_id.."msg:match:"..msg.sender_user_id_..":"..msg.chat_id_) or 0
send(msg.chat_id_, msg.id_,"*🍷❦︎عدد رسائلك الكلي هو :-*\n"..get_msg.." *من الرسائل*")
end  
...
send(msg.chat_id_, msg.id_,"*🍷❦︎عدد رسائل الشخص الكلي هو :-*\n"..get_msg.." *من الرسائل*")
end  
...
🍷 ↬⦑ SOURCE ICE ⦒ 
==================
🍷 ↬❦︎ [Source Channel](http://t.me/ICE53)
==================
🍷 ↬❦︎ [Source Update](http://t.me/ICE53)      
==================
🍷 ↬❦︎ [Source developer](http://t.me/ICE50)    
===================
🍷 ↬❦︎ [ICE programmer](http://t.me/ICE50)
===================
]]
send(msg.chat_id_, msg.id_,Text)
return false
...
if text == "ترتيب الاوامر" and Constructor(msg) then
 ...
 send(msg.chat_id_, msg.id_,"*🍷❦︎تم ترتيب الاوامر بالشكل التالي*\n*🍷❦︎ايدي - ا .*\n*🍷❦︎مميز - م .\n🍷❦︎ادمن - اد .*\n*🍷❦︎مدير - مد . \n🍷❦︎منشى - من .*\n*🍷❦︎المنشئ الاساسي - اس .*\n*🍷❦︎تعطيل الايدي بالصوره - تعط .*\n*🍷❦︎تفعيل الايدي بالصوره - تفع .*\n*🍷❦︎تنزيل الكل - تك .*\n*🍷❦︎اضف رد - رد .*\n*🍷❦︎حذف رد - حذ .*\n*🍷❦︎تثبيت - ت .*")
 end
...
send(msg.chat_id_, msg.id_, '*🍷❦︎بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIS1')..') \n*🍷❦︎تم تفعيل التنظيف التلقائي* ')
return false
end
if text == "تعطيل تنظيف التلقائي" and BasicConstructor(msg) then
database:del(bot_id.."LoMsg"..msg.chat_id_)
send(msg.chat_id_, msg.id_, '*🍷❦︎بواسطه* » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'IIIS1')..') \n*🍷❦︎تم تعطيل التنظيف التلقائي* ')
return false
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' 🍷❦︎ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'ICE53')..') \n 🍷❦︎ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 🍷❦︎ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'ICE53')..') \n 🍷❦︎ تـم قفـل التاك بالكتم ')
end,nil)   
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."ICE50:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'ICE50:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
local json_file, res = https.request("https://raw.githubusercontent.com/ICELTEAM/Files_ICE/main/Files_ICE/"..file)
if res == 200 then
os.execute("rm -fr Files_ICE/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ICE.lua')  
else
send(msg.chat_id_, msg.id_," 🍷∫ عذرا الملف لايدعم  ايس \n") 
end
return false
end
...
local UserName = (b.username_ or "SRC-ICE")
...
database:del(bot_id..'ICE50:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, ' 🍷❦︎ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'ICE50:MN:TF'..msg.chat_id_)
t = "\n 🍷❦︎ قائمة المنظفين \n≪━━━━━━𝐷𝐸𝑉𝐿━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'ICE50:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🍷❦︎ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
status  = '\n 🍷❦︎ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'ICE50:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n 🍷❦︎ العضو » ['..result.title_..'](t.me/'..(username or 'ICE53')..')'
status  = '\n 🍷❦︎ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'ICE50:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🍷❦︎ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
status  = '\n 🍷❦︎ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'ICE50:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🍷❦︎ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'ICE50:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n 🍷❦︎ العضو » ['..result.title_..'](t.me/'..(username or 'ICE53')..')'
status  = '\n 🍷❦︎ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'ICE50:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🍷❦︎ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
status  = '\n 🍷❦︎ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 🍷❦︎ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
status  = '\n 🍷❦︎ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 🍷❦︎ العضو » '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 🍷❦︎ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
...
return send(msg.chat_id_, msg.id_,"*🍷❦︎تم وضع وقت التنظيف ("..GetDo..") ساعه*")
end
...
Text = ' *🍷❦︎تم تفعيل التحقق*'
else
Text = ' *🍷❦︎بالتاكيد تم تفعيل التحقق*'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == 'تعطيل التحقق' and Manager(msg) then  
if not database:get(bot_id..'CAPTCHA'..msg.chat_id_) then
Text = '\n *🍷❦︎بالتاكيد تم تعطيل التحقق*'
else
...
database:set(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," 🍷❦︎ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ICE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ICE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," 🍷❦︎ تم منع الكلمه مع التحذير")  
database:del(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ICE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ICE1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ICE1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," 🍷❦︎ ارسل الكلمه الان")  
database:set(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ICE1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ICE1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ICE1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ICE1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ICE1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ICE1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n 🍷❦︎ قائمة المنع \n➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖\n"
for k,v in pairs(list) do  
local ICE_Msg = database:get(bot_id.."ICE1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ICE_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 🍷❦︎ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'ICE53')..')'..'\n 🍷❦︎ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'ICE50:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'ICE50:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."ICE50:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."ICE50:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "🍷❦︎ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."ICE50:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."ICE50:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايس').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'ايس')
local ICE_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..ICE_Msg[math.random(#ICE_Msg)]..']') 
return false
end
...
if database:sismember(bot_id..'ICE50:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'ICE50:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
send(msg.chat_id_, msg.id_,"🍷❦︎تم مسح ردود المطور")
end
...
send(msg.chat_id_, msg.id_,"🍷❦︎تم حفظ الرد بنجاح")
return false  
end  
end
...
send(msg.chat_id_, msg.id_,"🍷❦︎تم ازالة الرد من قائمه ردود المطور")
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n 🍷❦︎ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:ICE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:ICE:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:ICE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"🍷❦︎ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:ICE:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:ICE:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:ICE:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:ICE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:ICE:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:ICE:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:ICE:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:ICE:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:ICE:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:ICE:List:Rd:Sudo")
end
...
send(msg.chat_id_, msg.id_,"🍷❦︎تم مسح ردود المدير")
end
if text == ("ردود المدير") and Manager(msg) then
local list = database:smembers(bot_id.."List:Manager"..msg.chat_id_.."")
text = "🍷❦︎قائمه ردود المدير \n➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"🍷❦︎ارسل الكلمه التي تريد اضافتها")
...
send(msg.chat_id_, msg.id_,"🍷❦︎ارسل الكلمه التي تريد حذفها")
...
send(msg.chat_id_, msg.id_,"🍷❦︎تم ازالة الرد من قائمه الردود")
database:del(bot_id.."Add:Rd:Manager:Gif"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Vico"..text..msg.chat_id_)   
database:del(bot_id.."Add:Rd:Manager:Stekrs"..text..msg.chat_id_)     
database:del(bot_id.."Add:Rd:Manager:Text"..text..msg.chat_id_)   
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' 𝙎𝙊𝙐𝙍𝘾𝞝 𝙄𝘾𝙀.',url="t.me/ICE53"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."ICE53:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'🍷 تم تفعيل الانستا')
database:set(bot_id.."ICE53:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."ICE53:insta_bot"..msg.chat_id_) == "open" then
...
if database:get(bot_id.."ICE53:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري  ايس يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:ICE:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"🍷❦︎ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:ICE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ICE:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ICE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ICE:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:ICE:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:ICE:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:ICE:Add:Rd:Sudo:Text2"..test, text)  
end  
...
if text then
local Text = database:get(bot_id.."botss:ICE:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:ICE:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:ICE:Add:Rd:Sudo:Text2"..text)   
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'ايس').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'
local iduser = result.sender_user_id_
...
{
{text = ' 𝙎??𝙐𝙍𝘾𝞝 𝙄𝘾𝙀', url="t.me/ICE53"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴ\n🍷❦︎ ➫ .[ 𝙎𝙊𝙐𝙍𝘾𝞝 𝙄𝘾𝙀. ](t.me/ICE53)➤ ')
end
...
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴ
🍷❦︎استعاده الاوامر 
🍷❦︎تحويل كالاتي~⪼ بالرد على صوره او ملصق او صوت او بصمه بالامر ← تحويل 
🍷❦︎صيح ~ تاك ~ المميزين : الادمنيه : المدراء : المنشئين : المنشئين الاساسين
🍷❦︎كشف القيود
🍷❦︎تعين الايدي
🍷❦︎تغير الايدي
...
🍷❦︎~ الصور + متحركه + ملصق ~
🍷❦︎حظر ~ كتم ~ تقيد ~ طرد
🍷❦︎المحظورين ~ المكتومين ~ المقيدين
🍷❦︎الغاء كتم + حظر + تقيد ~ بالرد و معرف و ايدي
🍷❦︎تقيد ~ كتم + الرقم + ساعه
🍷❦︎تقيد ~ كتم + الرقم + يوم
🍷❦︎تقيد ~ كتم + الرقم + دقيقه
🍷❦︎تثبيت ~ الغاء تثبيت
🍷❦︎الترحيب
🍷❦︎الغاء تثبيت الكل
🍷❦︎كشف البوتات
...
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴ
🍷❦︎تفعيل ← تعطيل 
🍷❦︎المجموعات ← المشتركين ← الاحصائيات
🍷❦︎رفع ← تنزيل منشئ اساسي
🍷❦︎مسح الاساسين ← المنشئين الاساسين
🍷❦︎مسح المنشئين ← المنشئين
🍷❦︎اسم ~ ايدي + بوت غادر 
🍷❦︎اذاعه 
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴٴ
➫ .[ 𝙎𝙊𝙐𝙍𝘾𝞝 𝙄𝘾𝙀.](t.me/ICE53)➤
...
🍷❦︎قائمه العام
🍷❦︎مسح قائمه العام
🍷❦︎جلب نسخه الاحتياطيه
🍷❦︎رفع نسخه الاحتياطيه
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴ
🍷❦︎المتجر 
🍷❦︎متجر الملفات
🍷❦︎الملفات
🍷❦︎مسح الملفات
🍷❦︎تعطيل + تفعيل + اسم ملف
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴ
🍷❦︎اذاعه خاص
🍷❦︎اذاعه
🍷❦︎اذاعه بالتوجيه
...
🍷❦︎ جلب نسخه البوت
🍷❦︎رفع نسخه البوت
🍷❦︎ضع عدد الاعضاء + العدد
🍷❦︎ضع كليشه المطور
🍷❦︎تفعيل/تعطيل الاذاعه
🍷❦︎تفعيل/تعطيل البوت الخدمي
🍷❦︎تفعيل/تعطيل التواصل
🍷❦︎تغير اسم البوت
🍷❦︎اضف/حذف رد للكل
🍷❦︎ردود المطور
🍷❦︎مسح ردود المطور
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴ
🍷❦︎الاشتراك الاجباري
🍷❦︎تعطيل الاشتراك الاجباري
🍷❦︎تفعيل الاشتراك الاجباري
🍷❦︎حذف رساله الاشتراك
🍷❦︎تغير رساله الاشتراك
🍷❦︎تغير الاشتراك
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴ
🍷❦︎الاحصائيات
🍷❦︎المشتركين
🍷❦︎المجموعات 
🍷❦︎تفعيل/تعطيل المغادره
🍷❦︎تنظيف المشتركين
🍷❦︎تنظيف الكروبات
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴٴ
➫ .[ 𝙎𝙊𝙐𝙍𝘾𝞝 𝙄𝘾𝙀.](t.me/ICE53)➤
...
🍷❦︎مصه بالرد
🍷❦︎رزله بالرد 
🍷❦︎شنو رئيك بهذا بالرد
🍷❦︎شنو رئيك بهاي بالرد
🍷❦︎تحب هذا
➖➖➖➖⊱•𝙄𝘾𝙀•⊰➖➖➖➖ٴٴ
➫ .[ 𝙎𝙊𝙐𝙍𝘾𝞝 𝙄𝘾𝙀. ](t.me/ICE53)➤
]]
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'ايس')
...
ICE = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ICE)
...
------------------------------------------------------------------------
local ICEAbot = database:get(bot_id.."ICE1:Add:Filter:Rp2"..text..result.chat_id_)   
if ICEAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," 🍷❦︎ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n 🍷❦︎ ["..ICEAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ICE1_Msg = database:get(bot_id.."ICE1:Add:Filter:Rp2"..text..result.chat_id_)   
if ICE1_Msg then    
send(msg.chat_id_, msg.id_," 🍷❦︎ "..ICE1_Msg)
